...
def show_test():
    ...
    Player_Xchange = 0
    Player_Ychange = 0
    global Original_Player_Xchange
    Original_Player_Xchange = Screen_Width * 0.002125
    global Original_Player_Ychange
    ...
    def apply_powerup(powerup_type):
        ...
        if powerup_type == "ShotPower":
            ...
            Player_Ychange = Original_Bullet_Ychange
            Player_Xchange *= 2
            Player_Ychange *= 2
